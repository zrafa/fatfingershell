...
SDL_CreateTerminal (void)
{
    ...
    /* Terminal size */
    terminal->size.row    = 90;
    terminal->size.column = 30;
...
//        SDL_SetAlpha (terminal->surface, SDL_SRCALPHA|SDL_RLEACCEL, 180);
...
//	SDL_Surface* temp = SDL_CreateRGBSurface (SDL_SWSURFACE, w, h, 16, 0xf800,0x7e0, 0x1f, 0); 
    //if (temp == NULL) {
//        SDL_SetError (SDL_ENOMEM);
 //       exit(0);
  //      return -1;
   // }
//terminal->surface = SDL_DisplayFormat(temp);
//    terminal->surface = SDL_CreateRGBSurface (SDL_SWSURFACE, w, h, 16, 0xf800,0x7e0, 0x1f, 0); 
